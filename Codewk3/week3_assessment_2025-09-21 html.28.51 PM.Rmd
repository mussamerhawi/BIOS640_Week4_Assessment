...
# Import my dataset
clean_NHANES <- import(here("Datawk3", "cleaned_NHANES.csv"))
...
### NHANES Cleaned Data Viewer
Use the interactive table below to sort, filter, and search through the dataset.
```{r echo=FALSE}
library(DT)
datatable(clean_NHANES, 
...
ggsave(
  ...
  plot = age_histo,
  path = here("Reportswk3"),  # my folder
  width =6, height =4
)
```
...
diet_weight <- import(here("Datawk3","diet.csv"))
```
